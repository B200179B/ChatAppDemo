...
import com.example.chatapplecation01.databinding.ActivityMainPageBinding;
...
public class MainPage extends BaseActivity {
    ...
    private void setListeners() {
        ...
        binding.buttonProduct.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(),ProductPage.class)));
        binding.buttonSRTeam.setOnClickListener(v ->
